  ...
  return (
    <section ref={ref} className="min-h-screen relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#16425B] via-[#3A7CA5] to-[#81C3D7]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-3/4 right-1/4 w-12 h-12 text-white/20 animate-bounce" style={{ animationDelay: '1s' }}>
          <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="absolute top-1/2 left-1/6 w-6 h-6 text-white/20 animate-pulse">
          <svg viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className={`lg:w-1/2 text-white transform transition-all duration-1000 ${
            ...
            <h1 className={`text-5xl lg:text-6xl font-bold mb-6 leading-tight transform transition-all duration-1000 delay-300 ${
              isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            }`}>
              {content[language].title}
            </h1>
            
            <p className={`text-xl lg:text-2xl mb-8 text-white/90 font-light transform transition-all duration-1000 delay-500 ${
              isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            }`}>
              {content[language].subtitle}
            </p>
            
            <p className={`text-lg mb-12 text-white/80 max-w-lg transform transition-all duration-1000 delay-700 ${
              isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            }`}>
              {content[language].description}
            </p>
            
            <button className={`bg-white text-[#16425B] px-8 py-4 rounded-full font-semibold text-lg 
          ...
          {/* Profile Image */}
          <div className={`lg:w-1/2 flex justify-center transform transition-all duration-1000 delay-200 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
